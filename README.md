#### Note that this branch is deprecated. We used it for building Platform pre 2.x, but it is no longer the case. Please use the master branch for all versions of the Platform.
