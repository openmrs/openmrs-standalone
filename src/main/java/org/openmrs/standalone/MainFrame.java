...
public class MainFrame extends javax.swing.JFrame implements ActionListener, UserInterface {
	...
	public void showInitialConfig() {
		final JDialog configDialog = new JDialog(this, "Configure your OpenMRS 2.1 Installation", true);
		...
		final JButton demoDatabase = new JButton(
		        "<html><h3>Demonstration mode</h3>Configures OpenMRS 2.1 with a demonstration database. This is the quickest way to start up OpenMRS 2.1 with some sample data to evaluate the system or experiment with features</html>",
		...
		final JButton emptyDatabase = new JButton(
		        "<html><h3>Starter Implementation</h3>Configures OpenMRS 2.1 without any patient data. If you are familiar with OpenMRS 2.1 and want to start a new system, this is a good place to start.</html>",
		...
		JLabel instructions = new JLabel(
		        "<html><b>Welcome to OpenMRS 2.1! OpenMRS 2.1 can be configured in one of " + buttonList.size() + " ways, depending on your needs. Please click on the configuration that best meets your needs.</b><br/>(You will not see this next time you run OpenMRS 2.1)</html>");
