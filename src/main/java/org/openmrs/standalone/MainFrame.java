...
public class MainFrame extends javax.swing.JFrame implements ActionListener, UserInterface {
	...
	public void setStatus(String status) {
		setTitle(OpenmrsUtil.getTitle() + " - [" + status + "]");
	}
	...
	public void showInitialConfig() {
		...
		JLabel instructions = new JLabel(
		        "<html><b>Welcome to O3 RefApp v" + OpenmrsUtil.REFAPP_VERSION + "! O3 RefApp can be configured in one of " + buttonList.size() + " ways, depending on your needs. Please click on the configuration that best meets your needs.</b><br/>(You will not see this next time you run OpenMRS)</html>");
		...
		configDialog.setPreferredSize(new Dimension(700, 500));
		configDialog.pack();
