...
Option 1: Double click the 'standalone-1.1.jar' file in the expanded archive folder to launch OpenMRS.
...
Option 1: Double click 'standalone-1.1.jar' file in the expanded archive folder to launch OpenMRS.
