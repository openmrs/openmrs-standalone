...
Start 				This button runs tomcat, which will automatically start the mariaDB database engine if it was not already running. For the embedded mariaDB, the first connection 				     	automatically starts the mariaDB engine.
